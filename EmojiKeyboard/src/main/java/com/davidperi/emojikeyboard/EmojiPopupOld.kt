...
import com.davidperi.emojikeyboard.ui.state.PopupStateMachineOld
import com.davidperi.emojikeyboard.ui.view.EmojiKeyboardView

class EmojiPopupOld @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
) : FrameLayout(context, attrs) {

    private val keyboardView = EmojiKeyboardView(context)
    private var stateMachine = PopupStateMachineOld(this)
